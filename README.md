...
**Task 1: Controlling a servo motor using a webpage with arduino**

**1. Use the following guide to install the ESP32 board and Arduino IDE:**
   (https://github.com/ZiyadAlhussein/IOT-week-2-tasks-/blob/ESP32-Arduino/README.md)
...
```
![image](https://user-images.githubusercontent.com/108147030/183299780-db00818e-9768-4e3d-99c1-89e430901e93.png)
